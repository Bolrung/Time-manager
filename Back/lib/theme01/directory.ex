defmodule Theme01.Directory do
  @moduledoc """
  ...
  """
  def list_workingtimes!(userid, start, end_) do
    Repo.get!(Workingtime, user: userid, strat: start, end: end_)
  end
  ...
  @doc false
  def get_workingtime_with_userid!(id, userid), do: Repo.get_by!(Workingtime, id: id, user: userid)
